...
情况 2：资料不足，需要进一步检索
STATUS: SEARCH_MORE
RELEVANT_DOCS: [Doc1, Doc3] (仅列出包含有用信息的文档编号，若无则留空)
CLUES: [简要说明发现了什么信息，或者为什么需要继续搜索]
...
请基于上述文档内容，尝试回答问题。
重要原则：
1. 如果根据文档可以回答问题，请提供直接的答案。
2. 如果文档不足以回答，或者找不到相关信息，请严格只回答一句："根据知识库内容无法提供回答"，不要包含"已知相关信息"、"结论"或其他解释。
"""
